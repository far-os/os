...
export KERN_SIZE := 128

CFLAGS := -falign-functions=1 -fno-stack-protector -ffreestanding -m32 -march=i686 -Wall -Wextra -Werror=return-type -fpermissive -no-pie -Wimplicit-fallthrough=2 -D"KERN_SIZE=$(KERN_SIZE)"
